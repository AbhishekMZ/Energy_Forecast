...
Revision ID: 001
Create Date: 2024-12-10 18:36:10.000000
...
def upgrade():
    ...
    op.create_index('idx_city_name', 'cities', ['name'])
    ...
    op.create_index('idx_forecast_timestamp', 'forecasts', ['timestamp'])
    op.create_index('idx_forecast_city', 'forecasts', ['city_id'])
